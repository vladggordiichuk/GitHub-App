...
class NetworkManager {
    ...
    open func performRequest<D: Encodable, R: Decodable>(to endpoint: Endpoint, with jsonData: D, completion: @escaping (Result<R>) -> Void) {
    ...
    fileprivate func endpointToUrl(_ endpoint: Endpoint) -> URL? {
        ...
        let urlString = "https://api.github.com/search/" + endpoint.pathEnding
